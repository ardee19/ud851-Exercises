...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULT_RAW_JSON_KEY = "searchResultRawJSONKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.get(QUERY_URL_KEY) != null && savedInstanceState.get(SEARCH_RESULT_RAW_JSON_KEY) != null) {
                mUrlDisplayTextView.setText(savedInstanceState.getString(QUERY_URL_KEY));
                mSearchResultsTextView.setText(savedInstanceState.getString(SEARCH_RESULT_RAW_JSON_KEY));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String rawJSONString = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULT_RAW_JSON_KEY,rawJSONString);
