...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            ...
            Toast.makeText(this, "Make Sure Party Size is a whole number",Toast.LENGTH_SHORT).show();
            Log.e(LOG_TAG, "Failed to parse party size text to number: " + error.getMessage());
            return;
        }
